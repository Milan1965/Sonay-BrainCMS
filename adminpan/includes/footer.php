			<div class="col-12">
				<div id="footer-content">
                    <ul class="footer-links">
                        ...
                        <li><a href="/management">Medewerkers</a></li>
                        <li><a href="/vacatures">Vacatures</a></li>
                    </ul>

                    <p><?= $config['hotelName'] ?> &copy; <?= date('Y'); ?>. Alle rechten voorbehouden.<br />Gemaakt met <b>❤️</b> door Sonay & <a href="/home/David" style="text-decoration:none;color:grey;">David</a> met <b>VoxCMS</b>.</p>
					<!-- niet weghalen jano!-->
			   </div>
            </div>
<script>
