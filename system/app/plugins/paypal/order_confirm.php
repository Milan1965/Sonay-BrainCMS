		...
		*/
		...
		if( $ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING" )
		{
			...
			*/
			...
			".$_SESSION["Payment_AmountCredits"]." diamonds purchased<br>
			Thank you ".$_SESSION["username"]."!";
			$userTakeCredits = $dbh->prepare("UPDATE `users` SET vip_points = vip_points + :credits WHERE username = :user");
			$userTakeCredits->bindParam(':user', $_SESSION["username"]);
			$userTakeCredits->bindParam(':credits', $_SESSION["Payment_AmountCredits"]);
			$userTakeCredits->execute();
		}
		else  
		{
