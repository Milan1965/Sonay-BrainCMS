...
?>
    <title><?= $config['hotelName'] ?>: Event Team</title>
</head>
...
<body>
	...
	<div class="container">
            <div class="row">
                <div class="col-12">
                    <div id="title-headline">Event Beheerders</div>
                </div>
            </div>
            <div class="row">
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,motto,look,online,last_online,functie_site,functie_uitleg FROM users WHERE eventteam = 2");
$getMembers->execute();
...
?>
			...
			<div class="row">
                <div class="col-12">
                    <div id="title-headline">Event Leden</div>
                </div>
            </div>
            <div class="row">
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,motto,look,online,last_online,functie_site,functie_uitleg FROM users WHERE eventteam = 1");
$getMembers->execute();
if ($getMembers->RowCount() > 0)
{
while ($member = $getMembers->fetch())
...
<?php // hier komen al je event medewerkers, niet dat er uberhaupt iemand mee gaat doen met je kanker event maargoed ahahahahaha
