...
?>
    <title><?= $config['hotelName'] ?>: Expert Vacature</title>
</head>
        ...
        <div class="col-12">
				<div id="shadow-box" style="max-height:100%">
					<div class="title-box png20" style="background-color:#00796B;background-image:url(/templates/david_vox/img/expert.png);background-repeat: no-repeat;background-position: right;height: 80px;">
						<div class="title"><font color="white">Expert Vacature</font></div>
						<div class="desc"><font color="white">Je bent nu aan het solliciteren voor de functie: <b>Expert</b></font></div>
					</div>
					<div class="png20">
				<form action="" method="POST" autocomplete="off">
					...
					<p><label><b>Motivatie</b><br>
					<textarea name="motivatie" size="400" rows="5" cols="50" style="width: 100%;" id="in6"> </textarea></p>
