...
<body>
	...
	<div class="container">
            <div class="row">
                <div class="col-12">
                    <div id="title-headline">Hotel Management</div>
                </div>
            </div>
            <div class="row">
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,look,online,functie_site,functie_uitleg FROM users WHERE rank_site = '4' ORDER BY online DESC");
$getMembers->execute();
...
?>
			...
			<div class="row">
                <div class="col-12">
                    <div id="title-headline">Administrators</div>
                </div>
            </div>
            <div class="row">
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,motto,look,online,last_online,functie_site,functie_uitleg FROM users WHERE rank_site = '3' ORDER BY online DESC");
$getMembers->execute();
if ($getMembers->RowCount() > 0)
{
while ($member = $getMembers->fetch())
...
?>
			...
			<div class="row">
                <div class="col-12">
                    <div id="title-headline">Moderators</div>
                </div>
            </div>
            <div class="row">
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,motto,look,online,last_online,functie_site,functie_uitleg FROM users WHERE rank_site = '2' ORDER BY online DESC");
$getMembers->execute();
if ($getMembers->RowCount() > 0)
{
while ($member = $getMembers->fetch())
...
?>
			...
			<div class="row">
                <div class="col-12">
                    <div id="title-headline">Experts</div>
                </div>
            </div>
            <div class="row">
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,motto,look,online,last_online,functie_site,functie_uitleg FROM users WHERE rank_site = '1' ORDER BY online DESC");
$getMembers->execute();
if ($getMembers->RowCount() > 0)
{
while ($member = $getMembers->fetch())
