...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div id="shadow-box" style="background-image:url(/templates/david_vox/img/spambox.png);height: 115px;background-position: right;background-repeat: no-repeat;background-size: cover;">
