...
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,motto,look,online,last_online,functie_site,functie_uitleg FROM users WHERE spamteam = 2");
$getMembers->execute();
...
?>
                <div class="col-4">
                    <a href='/home/<?php echo $username; ?>' class="spam-box">
...
<?php
{
$getMembers = $dbh->prepare("SELECT id,username,motto,look,online,last_online,functie_site,functie_uitleg FROM users WHERE spamteam = 1");
$getMembers->execute();
if ($getMembers->RowCount() > 0)
{
while ($member = $getMembers->fetch())
