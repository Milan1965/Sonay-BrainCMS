	...
	<div class="container">
        ...
        <div class="col-12">
				<div id="shadow-box" style="max-height:100%">
					...
					<div class="png20">
						Habsie heeft jou de toegang geblokkeerd! !!!! Het kan zijn dat je een banned pagina in beeld krijgt terwijl je hier niks van af weet! ben je niet verbannen maar heb je toch een banned pagina? meld dit direct bij ons via de chat service rechts onderaan op de website. !!!!</p>
						<?php 
							if (loggedIn())
							{
