...
<body>
	...
	<div class="container">
            ...
            <div class="row">
<?php
$getRanks = $dbh->prepare("SELECT id,name,badgeid FROM teams WHERE id in (4)  ORDER BY id DESC");
						$getRanks->execute();
						while ($Ranks = $getRanks->fetch())
							{
								$getMembers = $dbh->prepare("SELECT id,username,motto,look,online FROM users WHERE djteam = :ranid");
