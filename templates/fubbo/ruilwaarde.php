...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div id="shadow-box" style="background-image:url(/templates/david_vox/img/lpromo_house18_gen.png);height: 115px;background-position: right;background-repeat: no-repeat;background-size: cover;">
					<div class="title-box png20">
						<div class="title">
						<font color="white" style="color: white;font-size: 175%">
						Hey, <?= User::userData('username') ?>!</font></div>
						<div class="desc"><font color="white" style="color: white">Dit is de officiële Habsie ruilwaarde, deze kun je hanteren tijdens het ruilen en gokken.<br>
						Momenteel is de diamant-belcredit schaal <img src="https://yabbis.nl/templates/david_vox/img/diamonds.png">10 : <img src="/ruilwaarde/bc.png" height="15px">1</font></div>
					</div>
				</div>
			</div>
		</div>
