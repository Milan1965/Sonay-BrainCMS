...
{
?>
<a href="/profiel/<?= filter($belcr_row['username']) ?>" style="text-decoration:none"><font color="grey"><?= filter($belcr_row['username']) ?></font></a>
...
?>
<a href="/profiel/<?= filter($belrs2_row['username']) ?>" style="text-decoration:none"><font color="grey"><?= filter($belrs2_row['username']) ?></font></a>
